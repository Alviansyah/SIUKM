        ...
        <table class="highlight">
            ...
            @foreach($surats as $i => $surat)
                <tr>
                    ...
                    <td>@if($surat->validasiBEM == 0)
                            <a style="width: 180px" href="/validasi/bem/surat/Keluar/{{$surat->idSurat}}" class="waves-effect waves-light btn">
                                <i class="material-icons left">done</i>Validasi</a>
                        @else
                            Tervalidasi
                            <a href="/batal/bem/surat/Keluar/{{$surat->idSurat}}" class="waves-effect waves-light btn">
                                <i class="material-icons left">not_interested</i>Batal</a>
                        @endif</td>
