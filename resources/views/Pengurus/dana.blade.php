...
@section('content')
            ...
            @foreach($danas as $i => $dana)
                <tr>
                    ...
                    <td><a href="/download/dana/{{$dana->idanggaran}}" class="waves-effect waves-light btn"><i class="material-icons left">play_for_work</i>Unduh</a>
                        <a href="/edit/dana/{{$dana->idanggaran}}" class="waves-effect waves-light btn"><i class="material-icons right">mode_edit</i>Ubah</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
    ...
    <div class="row">
        <a href="/form/dana" class="right btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
    </div>
@endsection