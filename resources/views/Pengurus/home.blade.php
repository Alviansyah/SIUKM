                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            ...
                            <li><a href="/adart" target="blank"><text class="grey-text">View AD/ART</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-reveal">
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            <li><a href="/form/anggota"><text class="grey-text">Tambah Data Anggota</text></a></li>
        ...
        <div class="card">
            ...
            <div class="card-reveal">
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            <li><a href="/surat/Masuk"><text class="grey-text">Surat Masuk</text></a></li>
                            <li><a href="/surat/Keluar"><text class="grey-text">Surat Keluar</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-reveal">
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            <li><a href="/form/pengurus"><text class="grey-text">Update Data Pengurus</text></a></li>
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            ...
                            <li><a href="/jadwal"><text class="grey-text">Jadwal Kegiatan</text></a></li>
                            <li><a href="/lpj"><text class="grey-text">LPJ</text></a></li>
                            <li><a href="/spj"><text class="grey-text">SPJ</text></a></li>
                            <li><a href="/proposal"><text class="grey-text">Proposal</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
