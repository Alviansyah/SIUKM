                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            ...
                            <li><a href=""><text class="grey-text">View AD/ART</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            ...
                            <li><a href=""><text class="grey-text">Lihat Data Anggota</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-reveal">
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            <li><a href=""><text class="grey-text">Surat Masuk</text></a></li>
                            <li><a href=""><text class="grey-text">Surat Keluar</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            ...
                            <li><a href=""><text class="grey-text">View Data Pengurus</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-reveal">
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            <li><a href=""><text class="grey-text">Anggaran Dana</text></a></li>
                            <li><a href=""><text class="grey-text">Dokumentasi</text></a></li>
                            <li><a href=""><text class="grey-text">Jadwal Kegiatan</text></a></li>
                            <li><a href=""><text class="grey-text">LPJ</text></a></li>
                            <li><a href=""><text class="grey-text">SPJ</text></a></li>
        ...
        <div class="card">
            ...
            <div class="card-reveal">
                ...
                <div class="row">
                    <div class="col offset-s1 offset-m1 offset-l1">
                        <ul>
                            <li><a href=""><text class="grey-text">View AD</text></a></li>
                            <li><a href=""><text class="grey-text">View ART</text></a></li>
                        </ul>
                    </div>
                </div>
            </div>
