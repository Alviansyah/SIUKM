        ...
        <nav class="blue darken-3">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a class="dropdown-button" href="#!" data-activates="drop">Surat<i class="material-icons right">arrow_drop_down</i></a></li>
                    <ul id="drop" class="dropdown-content dropdown-content-lower-pos">
